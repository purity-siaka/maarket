...
export default function ImpactPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16 text-black dark:text-white">
      ...
      <h1 className="mt-4 max-w-3xl text-4xl font-bold leading-tight text-black dark:text-white md:text-5xl">
      ...
      <section className="mt-14 grid gap-6 md:grid-cols-3">
        {impactPoints.map((point) => (
          <div key={point.title} className="rounded-2xl bg-neutral-100 dark:bg-neutral-900 p-6 border border-neutral-300 dark:border-neutral-800 transition-colors">
